...
export const CONTENT: Record<Language, Content> = {
  [Language.EN]: {
    ...
    aboutPage: {
      title: "History of Sarunsiriprapha Party",
  ...
  [Language.TH]: {
    ...
    home: {
      partyName: "พรรคศรัณย์ศิริประภา",
      slogan: "No Drama เน้นแก้ปัญหา พรรคศรัณย์ศิริประภาจัดให้",
    ...
    aboutPage: {
      title: "ความเป็นมาของ พรรคศรัณย์ศิริประภา",
      subtitle: "แสงสว่างแห่งสิริมงคลที่เป็นที่พึ่ง",
      intro: "ท่ามกลางปัญหาและความวุ่นวายในรั้วโรงเรียน เราตระหนักดีว่านักเรียนต้องการมากกว่าแค่คำสัญญา เราต้องการ \"ที่พึ่ง\" ที่อุ่นใจ และ \"แสงสว่าง\" ที่นำทางไปสู่ทางออกที่แท้จริง พรรคศรัณย์ศิริประภา จึงถือกำเนิดขึ้นภายใต้อุดมการณ์ที่ยึดถือความเป็นจริง",
      defTitle: "นิยามแห่งชื่อ: รากฐานแห่งความมุ่งมั่น",
      def1Title: "ศรันย์ (Refuge)",
    ...
    saranbotPage: {
      ...
      subtitle: "ผู้ช่วย AI ของพรรคศรัณย์ศิริประภา มีอะไรให้ผมช่วยดูแลไหมครับ?",
  ...
  return [
    {
      ...
      grade: "M.4/5",
      image: "https://img2.pic.in.th/IMG_4251.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/5",
      image: "https://img2.pic.in.th/IMG_4283a0977d3e8df8cd32.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/2",
      image: "https://img5.pic.in.th/file/secure-sv1/IMG_649650139b1f9ce19d4c.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/2",
      image: "https://img2.pic.in.th/IMG_4366.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/4",
      image: "https://img2.pic.in.th/IMG_4609.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/4",
      image: "https://img2.pic.in.th/IMG_4653b5e47f9a3076a9da.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/3",
      image: "https://img5.pic.in.th/file/secure-sv1/IMG_9190dd799df411ca76d2.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/1",
      image: "https://img2.pic.in.th/IMG_0347958b49e77f4f7533.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/4",
      image: "https://img5.pic.in.th/file/secure-sv1/IMG_45123406ffbf812cd956.jpeg",
      vision: isEn 
    ...
    },
    {
      ...
      grade: "M.4/3",
      image: "https://img2.pic.in.th/IMG_4463bcff7c75cdfadfd5.jpeg",
      vision: isEn 
