...
import { Content, Language, PolicyItem } from '../types';
import { POLICIES_DATA } from '../constants';
import { Play, Pause, Download, Info, ArrowLeft, ChevronRight, Share2, ChevronLeft } from 'lucide-react';
...
export const Policies: React.FC<PoliciesProps> = ({ content }) => {
  ...
  return (
    <div className="min-h-screen bg-party-cream font-sans overflow-x-hidden relative">
        <style>{`
        ...
        {/* =========================================================================
            LIST VIEW (3D SEMI-CIRCULAR CAROUSEL)
           ========================================================================= */}
        <div className={`transition-all duration-1000 ease-in-out ${selectedId ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}>
            <div 
            ...
            >
                ...
                {/* Carousel Controls */}
                <div className="container mx-auto px-6 flex justify-center items-center gap-10 mt-8 relative z-20">
                    <button 
        ...
        <div 
            ...
            className={`fixed inset-0 z-[60] bg-party-cream overflow-y-auto transition-transform duration-800 ease-[cubic-bezier(0.16,1,0.3,1)] ${selectedId ? 'translate-y-0' : 'translate-y-full'}`}
        >
            {activePolicy && (
                <div className="relative min-h-screen">
                    <div className="sticky top-0 left-0 right-0 z-50 bg-party-cream/80 backdrop-blur-xl border-b border-party-black/5 px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="max-w-5xl mx-auto px-6 py-12">
                        <div className="relative h-[45vh] md:h-[55vh] rounded-[4rem] overflow-hidden mb-16 shadow-2xl">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16 p-10 bg-white/60 backdrop-blur-xl rounded-[3.5rem] border border-party-black/5 shadow-xl">
                            ...
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                ...
                                <button onClick={handleDownloadCard} disabled={isGenerating} className="flex-1 md:flex-none flex items-center justify-center gap-3 px-10 py-5 rounded-2xl font-bold text-sm bg-white border border-party-black/10 text-party-black hover:bg-party-beige/20 transition-all shadow-lg active:scale-95 disabled:opacity-50">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                            <div className="lg:col-span-8 space-y-16">
                                <div className="group relative">
                                    ...
                                    <div className="p-12 rounded-[3rem] bg-white border border-party-black/5 shadow-md"><p className="text-2xl md:text-3xl font-serif text-party-black/80 leading-relaxed italic">"{activePolicy.why}"</p></div>
                                </div>
                            ...
                            <div className="flex-1 flex flex-col justify-between py-24 z-10">
                                ...
                                <div className="flex items-end justify-between pt-20 border-t-4 border-[#B93847]/10">
                                    <div className="max-w-[70%] space-y-8">
                                        <h2 className="text-6xl font-serif italic text-[#1F1F1F] font-semibold leading-tight">"No drama เน้นแก้ปัญหา พรรคศรัณย์ศิริประภาจัดให้"</h2>
